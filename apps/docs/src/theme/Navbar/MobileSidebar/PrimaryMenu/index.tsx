 ...
 *
 * Items are kept in sync with apps/docs/sidebars.ts by hand.
 */
...
const ITEMS: Item[] = [
	...
	{ label: 'npm', href: 'https://www.npmjs.com/package/@rtorcato/api-errors' },
]
