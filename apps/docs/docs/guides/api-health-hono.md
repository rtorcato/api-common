---
title: api-health-hono
description: Hono liveness/readiness probe handlers for @rtorcato/api-health.
---

`@rtorcato/api-health-hono` provides ready-made Hono handlers for liveness and readiness probes, backed by an [`@rtorcato/api-health`](./api-health.md) registry.
